...
public class MarvelService {
    ...
    public SuperHero searchById(Integer id) {
        ...
        System.out.println("searchById - url >>>>: " + url);
        ...
        return SuperHero.create(data.getJsonObject(0));
    ...
    public List<SuperHero> search(String name, Integer limit) {
        ...
        // https://gateway.marvel.com:443/v1/public/characters?limit=10&apikey=9701148d41217aaeede3f743f2877e22
        // nameStartWith=captain
        // limit=10
        // ts=
        // apiKey=
        // hash=
